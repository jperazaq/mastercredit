...
?>
                ...
                <form action="" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="papellido" name="papellido" aria-describedby="emailHelp">
                  </div>

                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Segundo Apellido</label>
                    <input type="text" class="form-control" id="sapellido" name="sapellido" aria-describedby="emailHelp">
                  </div>
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    </div> <a href="login.php">Inciar Sesión</a>
                  </div>
                  <button type="submit" name="regUser" id="regUser" class="btn btn-primary">Agregar Usuario</button>
